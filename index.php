...
require_once __DIR__ . '/MultiHilos/CardProcessor.php';
...
$db = new MysqliDb ('MySQL.railway.internal', 'root', 'IRFIdAFDzytjKaUnaWddxOqhReIrFqMq', 'telegram_bot_cc');

$telegram = new Telegram("8085937206:AAHiyhhiuTtbAqjbDAyay8U223sECnELgjM");
